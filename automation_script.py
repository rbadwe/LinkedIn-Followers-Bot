...
# Login
# =============================================================================
email_or_phone_no = webdriver.find_element_by_xpath('/html/body/div/main/div[2]/div[1]/form/div[1]/input')
#/html/body/div/main/div[2]/div[1]/form/div[1]/input
email_or_phone_no.send_keys(EMAIL_OR_PHONE_NO) 
password = webdriver.find_element_by_xpath('/html/body/div/main/div[2]/div[1]/form/div[2]/input')
password.send_keys(PASSWORD)  
sleep(5)
try:
    button_login = webdriver.find_element_by_xpath('/html/body/div/main/div[2]/div[1]/form/div[3]/button')
except:
    button_login = webdriver.find_element_by_xpath('/html/body/div/main/div[2]/div[1]/form/div[4]/button')
button_login.click()
sleep(3)
...
# =============================================================================
notnow = webdriver.find_element_by_xpath('/html/body/div[7]/header/div[2]/nav/ul/li[2]/a/span')
notnow.click() 
sleep(4)
#mssg = webdriver.find_element_by_xpath('/html/body/div[7]/aside/div[1]/header/section[2]/button[2]/span')
#mssg.click()
#sleep(6)

seeall = webdriver.find_element_by_xpath('/html/body/div[7]/div[3]/div/div/div/div/div/div/div/main/ul/li[1]/div/button/span')
# /html/body/div[7]/div[3]/div/div/div/div/div/div/div/main/ul/li[1]/div/button/span
# /html/body/div[7]/div[3]/div/div/div/div/div/div/div/main/ul/li[1]/div/button/span
# /html/body/div[7]/div[3]/div/div/div/div/div/div/div/main/ul/li[1]/div/button/span
#button = webdriver.find_element_by_xpath("/html/body/div[7]/div[3]/div/div/div/div/div/div/div/main/ul/li[1]/div/button/span")
...
for i in range(1,1000):
    ...
    webdriver.find_element_by_xpath(f'/html/body/div[3]/div/div/div[2]/ul/li['+str(i)+']/div/section/div[2]/footer/button/span').click()
	# /html/body/div[7]/div[3]/div/div/div/div/div/div/div/main/ul/li[1]/ul/li{i}/div/section/div[2]/footer/button/span
	# /html/body/div[3]/div/div/div[2]/ul/li[1]/div/section/div[2]/footer/button/span
    if i%12==0:
        sleep(3)
